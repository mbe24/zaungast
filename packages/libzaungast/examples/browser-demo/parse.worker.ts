...
// and returns the reply + the ArrayBuffers to move zero-copy. The coordinator (worker.ts) spawns N of
// these via createPool. The parse/extract logic itself lives in the library, so this stays trivial.
