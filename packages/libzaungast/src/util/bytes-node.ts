...
// Dedup key: Buffer's latin1 is already native-speed + injective, so on Node it IS toLatin1 (by
// construction — not a parallel impl that could drift).
export const dedupKey: BytesCodec['dedupKey'] = (u8) => toLatin1(u8);
